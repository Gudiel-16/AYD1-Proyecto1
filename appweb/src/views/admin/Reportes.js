...
const Reportes = () => {
                ...
                data.data.reportes.forEach(item => {
                    if (item.usuario_nombreusuario == "usuarioTest") {
                        ...
                        if (item.resuelto != "2") {
                            ...
                            result[item.codigo] = [item.usuario_nombreusuario, nombreReporte, item.fecha, item.hora, item.codigo + "|" + item.encargado, reporteCompleto, activarRes];
                        }
                    }
                });
                setState(result_)
    ...
    function handleClickVerQuien(s) {
        Swal.fire({
            icon: 'info',
    ...
    const columns = [
            ...
            options: {
                ...
                customBodyRender: (value) => (
                    <FormGroup row>
                        <FormControlLabel
                            control={
                                version(String(value).split("|")[0]) == false ? <div>No <Switch
                                    checked={version(String(value).split("|")[0])}
                                    onChange={handleChange}
                                    name={"a" + String(value).split("|")[0]}
                                    color="primary"
                                /> Si</div> :
                                    ...
                                    <Chip
                                        ...
                                        clickable
                                        color="primary"
                                        onDelete={() => handleClickVerQuien(String(value).split("|")[1])}
                                        onClick={() => handleClickVerQuien(String(value).split("|")[1])}
                                        deleteIcon={<DoneIcon />}
                                    />
        ...
        },
        {
            ...
            options: {
                ...
                customBodyRender: (value) => (
                    <FormGroup row>
                        {(String(value).split("|"))[1] == "si" ? <Button color="primary" variant="contained" onClick={() => verify(String(value).split("|")[0], String(value).split("|")[2])} className="resuelto">
                            Resolver
                        </Button> : <Button variant="contained" className="resueltoDisabled" disabled>
                            Resolver
                        </Button>}
                    </FormGroup>
                )
    ...
    async function verReporteCompleto(datos) {
        ...
        //html: '<img width="256" class="reporte" src="data:image/png;base64,{base64}" />',
        ...
        /*'<img width="128" class="reporte" peros="mas1" src="https://pm1.narvii.com/7240/de1d4caab152d6ee6f6f9bd99fdde5ee203ae036r1-480-484v2_hq.jpg" /><img width="128" class="reporte" src="https://pm1.narvii.com/7240/4d818dde9cfa5ebc9f053947e876d909f9cc6882r1-480-500v2_hq.jpg" peros="mas2" />',
            background: '#fff url(https://image.freepik.com/foto-gratis/textura-papel-ligero-fondo_105034-732.jpg)' */
    }
